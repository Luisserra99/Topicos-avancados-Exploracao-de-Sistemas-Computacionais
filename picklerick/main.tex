...
%============================= 2.3 VISAO GERAL ==================================
\section{Visão Geral}
\textbf{Pickle Rick} é uma máquina Linux de dificuldade \emph{fácil}, 
que expõe um servidor web Apache. A superfície
...
qualquer comando como \texttt{root} sem senha), utilizada para escalação de privilégio \texttt{root}.
